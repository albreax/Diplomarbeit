...
Basierend auf Hunt und Thomas (\citeyear[vgl.][23]{TN_libero_mab2}) wurde zunächst eine zusammenfassende Übersicht der Projektesstruktur erzeugt. 
Ausgehend von dieser wurde einzelne Aspekte der Architektur analysiert und dargestellt.

% Software architecture recovery based on pattern matching => S 17 - 18
% 
...
Mit Hilfe der Abhängigkeitsgraphen und der Analyse des Quelltext wurden die Bausteine, aus denen der FreeDesign-Editor besteht, identifiziert. 
